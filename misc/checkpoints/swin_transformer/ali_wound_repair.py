...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='/mnt/hdd2/ALI_Repair/final/annotations/train.json',
        img_prefix='/mnt/hdd2/ALI_Repair/final/images/train/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(
    ...
    val=dict(
        type='CocoDataset',
        ann_file='/mnt/hdd2/ALI_Repair/final/annotations/val.json',
        img_prefix='/mnt/hdd2/ALI_Repair/final/images/val/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
workflow = [('train', 1)]
fp16 = None
work_dir = './work_dirs/ali_wound_repair_config'
gpu_ids = range(0, 1)
