model = dict(
    ...
    rpn_head=dict(
        ...
        anchor_generator=dict(
            ...
            scales=[16],
            base_sizes=[0.5, 1.375, 2.25, 3.125, 4.0],
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/mnt/hdd3/cell_division/final2/annotations/instances_train.json',
        img_prefix='/mnt/hdd3/cell_division/final2/images/train/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        '/mnt/hdd3/cell_division/final2/annotations/instances_val.json',
        img_prefix='/mnt/hdd3/cell_division/final2/images/val/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
workflow = [('train', 1)]
fp16 = None
work_dir = './work_dirs/cell_division2'
gpu_ids = range(0, 1)
